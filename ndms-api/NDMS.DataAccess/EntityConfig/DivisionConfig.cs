...
{
    /// <summary>
    /// Entity configuration class for Division entity
    /// </summary>
    public class DivisionConfig : BaseEntityTypeConfiguration<Division>
    {
        #region Constructor(s)
        /// <summary>
        /// Default Constructor
        /// </summary>
        public DivisionConfig() : base()
        {
            this.ToTable("Divisions").HasKey<int>(e => e.Id); //table primary key
