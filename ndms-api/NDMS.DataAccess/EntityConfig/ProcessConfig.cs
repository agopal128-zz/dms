...
{
    /// <summary>
    /// Entity configuration class for Process entity
    /// </summary>
    public class ProcessConfig : BaseEntityTypeConfiguration<Process>
    {
        #region Constructor(s)
        /// <summary>
        /// Default Constructor
        /// </summary>
        public ProcessConfig() : base()
        {
            this.ToTable("Processes").HasKey<int>(e => e.Id); //table primary key
