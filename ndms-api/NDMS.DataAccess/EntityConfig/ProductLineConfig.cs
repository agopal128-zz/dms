...
{
    /// <summary>
    /// Entity configuration class for ProductLine entity
    /// </summary>
    public class ProductLineConfig : BaseEntityTypeConfiguration<ProductLine>
    {
        #region Constructor(s)
        /// <summary>
        /// Default Constructor
        /// </summary>
        public ProductLineConfig() : base()
        {
            this.ToTable("ProductLines").HasKey<int>(e => e.Id); //table primary key
