...
{
    /// <summary>
    /// Represents annual target history
    /// </summary>
    public class TargetHistory : BaseEntity
    {
        ...
        /// <summary>
        /// Id of the corresponding Annual Target(Foreign key attribute)
        /// </summary>
        ...
        /// </summary>
        public bool IsCascadeFromParent { get; set; }
        ...
        ///<summary>
        /// Flag which says whether the target is Deleted 
        /// </summary>
        ...
        /// <summary>
        /// Annual Target Navigational Property
        /// </summary>
