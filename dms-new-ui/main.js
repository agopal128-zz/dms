...
require.config({
    ...
    paths: {
        ...
        circleProgress: 'Scripts/circle-progress/circle-progress.min',
        ...
        progressValueDirective: 'ngDirectives/progress-value-directive.min',
        scorecardDropdown:'ngDirectives/scorecard-dropdown-directive.min',
