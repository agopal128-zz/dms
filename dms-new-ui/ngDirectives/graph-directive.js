            ...
            link: function ($scope, $element, $attrs) {
                ...
                $scope.$watch('chartData', function (value) {
                    ...
                    if ($scope.chartData.series) {
                        ...
                        graphData.series[0].data = $scope.chartData.series[2].data; // actual
                        graphData.series[2].data = $scope.chartData.series[0].data; // goal 
                        graphData.series[1].data = $scope.chartData.series[1].data; // stretch goal
